...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo $direccion; ?>/img/favicon.png">

    <meta name="description" content="">

    <script src="<?php echo $direccion; ?>/js/jquery.min.js"></script>
    <!-- CSS -->
    <link href="<?php echo $direccion; ?>/css/preload.css" rel="stylesheet" media="screen">
    <link href="<?php echo $direccion; ?>/css/bootstrap.css" rel="stylesheet" media="screen">
    <link href="<?php echo $direccion; ?>/css/font-awesome.min.css" rel="stylesheet" media="screen">
    <link href="<?php echo $direccion; ?>/css/animate.min.css" rel="stylesheet" media="screen">
    <link href="<?php echo $direccion; ?>/css/slidebars.css" rel="stylesheet" media="screen">
    <link href="<?php echo $direccion; ?>/css/lightbox.css" rel="stylesheet" media="screen">
    <link href="<?php echo $direccion; ?>/css/jquery.bxslider.css" rel="stylesheet">
    <link href="<?php echo $direccion; ?>/css/syntaxhighlighter/shCore.css" rel="stylesheet" media="screen">

    <link href="<?php echo $direccion; ?>/css/style-blue.css" rel="stylesheet" media="screen" title="default">
    <link href="<?php echo $direccion; ?>/css/width-full.css" rel="stylesheet" media="screen" title="default">

    <link href="<?php echo $direccion; ?>/css/buttons.css" rel="stylesheet" media="screen">

    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
        <script src="<?php echo $direccion; ?>/js/html5shiv.min.js"></script>
        <script src="<?php echo $direccion; ?>/js/respond.min.js"></script>
    <![endif]-->
</head>
<!-- Preloader -->
<div id="preloader">
            ...
            <nav class="navbar navbar-static-top navbar-default navbar-inverse" role="navigation" id="header">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand active" href="<?php echo $direcciones['inicio']; ?>">Dynaco-<span>Solutions</span></a>
                    </div> <!-- navbar-header -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="<?php echo $direcciones['inicio']; ?>" class="dropdown-toggle" data-toggle="">Inicio</a>
                            </li>
                            <li class="dropdown">
                                <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">Dynaco</a>
...
<!--
                                    ...
                                    <li><a href="https://www.google.com/">Salir<span class="label label-success pull-right">Bye</span></a></li>
-->
                                </ul>
                            </li>
                            <li class="">
                                <a href="<?php echo $direcciones['contacto']; ?>" class="dropdown-toggle" data-toggle="">Contáctanos</a>
                            </li>
                        </ul>
                    </div>
        <!--
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">Home</a>
                     <ul class="dropdown-menu dropdown-menu-left">
                        <li><a href="<?php echo $direcciones['inicio']; ?>" class="active">Option 1: Default</a></li>
